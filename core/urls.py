...
from .admin_views import (
    ...
    admin_download_courses_pdf,
    admin_download_invoice_pdf,
    admin_analytics,
    admin_activity,
    admin_dashboard,
    update_lesson_order,
...
urlpatterns = [
    ...
    path('master/download-courses-pdf/', admin_download_courses_pdf, name='admin_download_courses_pdf'),
    path('master/invoice/<int:order_id>/download/', admin_download_invoice_pdf, name='admin_download_invoice_pdf'),
